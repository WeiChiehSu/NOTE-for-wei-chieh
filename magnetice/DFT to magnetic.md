...
$$
Normal:n_{\alpha } (r)=\sum_{\alpha  }\left \langle \psi^{*}  \right | \psi _{\alpha   }^{*}(r) \psi _{\alpha }(r)\left | \psi  \right \rangle\Longrightarrow Spin:n_{\alpha,\beta } (r)=\sum_{\alpha ,\beta  }^{}\left \langle \psi^{*}  \right | \psi _{\beta  }^{*}(r) \psi _{\alpha }(r)\left | \psi  \right \rangle  [\alpha ,\beta=\uparrow ,\downarrow  ]
$$
