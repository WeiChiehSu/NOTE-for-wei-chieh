...
$$
\Longrightarrow \frac{E_{x} }{\Omega }=-\frac{1}{2}\sum_{\sigma }\int_{\left | k \right | \le k_{F}}\frac{d^{3}k }{(2\pi )^{3} }\int_{\left | k \right | \le k_{F}}\frac{d^{3}k' }{(2\pi )^{3} }\frac{4\pi }{\left | k-k' \right | } \Longrightarrow \frac{E_{x} }{\Omega }=\varepsilon _{x}=-\frac{3k_{F} }{4\pi },k_{F}=(3\pi ^{2}n)^{\frac{1}{3} }    
$$
